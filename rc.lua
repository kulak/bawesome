...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn('/usr/bin/rofi -show run -font "System San Francisco Display 14"') end,
              {description = "run prompt", group = "launcher"}),

    -- Window Switcher
    awful.key({ "Mod1" },          "Tab",     function () awful.spawn('/usr/bin/rofi -show window -font "System San Francisco Display 14"') end,
